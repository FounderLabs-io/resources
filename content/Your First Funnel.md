...
> [!warning] Do NOT do this unless you're B2B
> 
> **Build → Demo → Sell**
...
For SaaS: signup, complete onboarding, hit their first "[aha moment](https://writings.founderlabs.io/p/how-to-increase-mrr-activating-users)".
For services: book a call, reply to an email, attend a demo.
...
_This resource is part of the [Founder Labs Resources](https://claude.ai/) library. Questions? Drop them in Slack._