...
1. **Customer Discovery** - Testing if customers have the problems you think they have and if your solution addresses them
2. **Customer Validation** - Building a repeatable sales model with early customers
3. **Customer Creation** - Scaling demand creation (marketing/sales)
4. **Company Building** - Transitioning from search mode to execution mode
...
1. **Identify your variables:** What are you changing and what are you measuring?
