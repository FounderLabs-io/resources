...
**Based on:** Rob Fitzpatrick's "[The Mom Test](https://amzn.to/450XT6t)" + real-world application early-stage founders and their customers
...
1. **Leverage existing communities** (Reddit, Facebook groups, Slack channels, Discord)
2. **Cold outreach** to people who've posted about the problem in those communities
3. **Warm intros** through your network ("Do you know anyone who..." describe your ICP)
4. **Partner channels** (talk to service providers who serve your ICP) (🔥 tip: this is a great one for many reasons you may tap into later in the journey!)
5. **Your own network** (not friends/family, but weak ties who fit the ICP)
...
1. **Scheduling has to be one of the top 3 problems of small home service professionals.** 
...
2. **Small home service professionals have to be trying to solve it with a shared Google Calendar, and they hate it with a passion.**
   "How have you solved, or are trying to solve, the scheduling issues you're experiencing today?  Or are you even trying to solve it right now?" And then, why aren't they trying to solve it right now, if not? This might lead to more important problems than the one you're focused on. (Problem urgency, competition, problem identification)
3. **They have to hate Google Calendar enough to switch and pay within a day, even though Google Calendar is free.**
   "Let's just say I could fix this problem for you (I'm not saying I can, but what if)... what would have to be true for you to switch to it today?" (Switching cost tolerance, objections, price points, value and delight opportunities/features)
...
1. The problem is REAL (they felt pain recently)
2. The problem is URGENT (happened last week)
3. Current solution SUCKS (manual tracking failed them)
4. They're a BUYER (frustrated enough to pay for solution)
...
1. **Top 3 learnings** - What surprised you?
2. **Emotional quotes** - Write the exact phrases they used when emotional
3. **Next steps** - Did they offer intros? Agree to pilot? Ask to buy?
4. **Contradictions** - What didn't match your assumptions?
...
- Where did you hear about the solution you're using (Potential watering holes or [partners](https://writings.founderlabs.io/p/how-to-partner-for-more-sales-and))
...
- "That's just like `[existing tool]`"
- Can't articulate why they would or what would need to be true to switch
...
1. **User:** Does it solve their problem?
2. **Buyer:** Does it fit their budget/priorities?
3. **Gatekeeper:** Does it pass security/compliance?

Part of your job in this case is to figure out [what the power dynamic is](https://writings.founderlabs.io/p/how-to-sell-if-your-user-is-not-the). 
...
- "What's the last `[category of solution]` you bought? Why that one?"
- "What's your typical budget for this?"
...
1. Join groups, provide value (answer questions, share knowledge, earn trust)
2. Weeks later, start some research posts: "I've heard some people are frustrated with `x`, why is that?" (basically spark your ICP's emotions and get them talking about the problems).
3. A week or two later, DM people who engaged in the post with one of the [[The Mom Test#Sample Outreach Messages|sample outreach messages for communities]].
...
**Original source:**  
"[The Mom Test](https://amzn.to/450XT6t)" by Rob Fitzpatrick
...
**Additional reading:**
- "[Talking to Humans](https://amzn.to/4jwPmhq)" by Giff Constable (shorter, more tactical)
